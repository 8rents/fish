# 8rent's Fish Shell Configs

>  *Fish configurations for various platforms.*
...
This repository contains a few branches that are not specific to platforms. These include:

- [**`| info (default) |`**](https://github.com/8rents/fish/) - front facing / platform agnostic info
- [**`| blank |`**](https://github.com/8rents/fish/tree/blank) - A blank branch with a blank readme template
